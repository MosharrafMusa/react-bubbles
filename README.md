...
- [ ] Explain what a token is used for.
      ...
      Answer: A token is used to authenticate a user that has logged in with correct credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

      Answer:Authenticate users and utilize protected routes for sensitive data.

- [ ] Describe how web servers work.

      Answer: The most simple way to describe how web servers work is that when you open up your browser and look up a website by typing in a URL, your browser connects to a server (the physical computer), requests the web server (the program) for the website that matches the URL, and said web server then sends back the requested website.
